...
<div class="alert alert-danger" role="alert"  style="margin-top: 60px">${err_msg}</div>
<%--<form method="post" action="http://localhost:8080/article/upload.do">--%>
<form>
    <div class="editormd" id="test-editormd">
        <textarea class="editormd-markdown-textarea" name="test-editormd-markdown-doc" id="test-editormd-markdown-doc">
# Editor.md
...
### End
    ...
    <div style="width:90%;margin: 10px auto;">
        <%--<input type="submit" class="btn btn-lg btn-primary" name="submit" value="Submit" style="padding: 5px;" />--%>
        <a class="btn btn-primary btn-lg btn-block" onclick="submitContent()">submit</a>
    </div>
</form>
