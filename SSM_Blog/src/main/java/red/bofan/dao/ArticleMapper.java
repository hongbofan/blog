...
public interface ArticleMapper {
    Map insertSelectiveDDL(Integer count);
    List<Article> selectByPageWithSearch(@Param("title") String title,@Param("startrow") Integer startrow, @Param("rows") Integer rows);
    List<Article> selectByPageWithSearchDDL(@Param("title") String title,@Param("startrow") Integer startrow, @Param("rows") Integer rows);
    int selectCountBySearch(@Param("title") String title);
    int selectCountBySearchDDL(@Param("title") String title);
    /**
